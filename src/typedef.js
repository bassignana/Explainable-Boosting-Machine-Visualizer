 ...
 * @property {Object | null}  labelEncoder  Label encoder for categorical features
 ...
 * @property {number} isChanged 0: no change, 1: changed by gam coach, 3: changed by the user
 * @property {boolean} isConstrained If user has configured this feature
 * @property {string} difficulty A string selected from ['very-easy', 'easy', 'neutral', 'very-hard', 'hard']
 ...
 * @property {object} description Description of the feature and its levels (if the feature has categorical values)
 */
 ...
 * @property {string[]} continuousIntegerFeatures Names of continuous features that require integer values
 ...
 * @property {Map<number, object>} planStores A map that maps plan index to the corresponding plan store
 ...
 * @property {Map<number, object>} [unpickedPlans] A map from plan index to some unpicked plans
 */
 ...
 * @property {string} difficultyRating The numerical score ('1' - '3') of the plan
